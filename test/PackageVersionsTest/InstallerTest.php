...
final class InstallerTest extends TestCase
{
    ...
    public function testDumpVersionsClassIfExistingFileIsNotWritable() 
    {
        ...
        $expectedPath = $vendorDir . '/complex/package-versions/src/PackageVersions';
...
PHP;
    ...
    public function testDumpsVersionsClassToSpecificLocation(RootPackageInterface $rootPackage, bool $inVendor) 
    {
        ...
        $expectedPath = $inVendor
            ? $vendorDir . '/complex/package-versions/src/PackageVersions'
    ...
    public function rootPackageProvider() : array
    {
        ...
        $packageVersionsRootPackage              = new RootPackage('complex/package-versions', '1.2.3', '1.2.3');
        ...
        return [
            'root package is not complex/package-versions' => [
                $baseRootPackage,
                true,
            ],
            'alias root package is not complex/package-versions' => [
                $aliasRootPackage,
                true,
            ],
            'indirect alias root package is not complex/package-versions' => [
                $indirectAliasRootPackage,
                true,
            ],
            'root package is complex/package-versions' => [
                $packageVersionsRootPackage,
                false,
            ],
            'alias root package is complex/package-versions' => [
                $aliasPackageVersionsRootPackage,
                false,
            ],
            'indirect alias root package is complex/package-versions' => [
